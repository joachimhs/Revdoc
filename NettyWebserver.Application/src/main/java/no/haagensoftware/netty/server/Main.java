...
public class Main {
	...
	private static void setProperties(Properties properties) {
		...
		if (System.getProperty("netty-webserver.webappDirectory") == null) {
			error = true;
			logger.info(" * SEVERE: Property 'netty-webserver.webappDirectory' is not specified. Terminating! Please specify in config.properties");
		}
		
		if (System.getProperty("revdoc.xmlDir") == null) {
			error = true;
			logger.info(" * SEVERE: Property 'revdoc.xmlDir' is not specified. Terminating! Please specify in config.properties");
		}
		
		if (System.getProperty("revdoc.dbName") == null) {
			error = true;
			logger.info(" * SEVERE: DB not configured. Please specify in config.properties: revdoc.dbName, revdoc.dbHost, revdoc.dbUser, revdoc.dbPass, revdoc.dbQueryFile");
		}
